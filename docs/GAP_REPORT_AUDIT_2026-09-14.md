...
| 8 | "16 Conformer blocks", "4 or 8 heads" | **Contradicts** | `V-05-04` registers `d_model=256`, 12 encoder blocks, 4 heads, `linear_units=2048`, `cnn_kernel=15`; and `plan-v2.md` §4.2 forbids writing any of these numbers before a fetch registers them |
