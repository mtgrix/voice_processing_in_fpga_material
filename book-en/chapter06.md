...
which does the low-passing with adders and registers alone: no multipliers at all. [Figure 21](#fig-ch6-pdm-cic)
...
about them. [Figure 22](#fig-ch6-line-buffer) draws the three quantities as one window sliding over
the stream.
...
[Figure 23](#fig-ch6-r2sdf-stage) draws one stage, and [Figure 24](#fig-ch6-r2sdf-pipeline) chains
nine of them.
...
[Figure 25](#fig-ch6-mel-pipeline) draws the three stages as one datapath.
