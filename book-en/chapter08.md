...
[Figure 7](#fig-kws-signal-path) puts the path on one line, and it is where the two clocks show.
...
> drawn in [Figure 9](#fig-nonlinearity-approx), and both variants there pay it.
>
...
[Figure 9](#fig-nonlinearity-approx) puts the two routes side by side. Look at what each path
