...
to look back, so they persist. That pair is the cache, and [Figure 10](#fig-appendix-attention) draws it
...
**Hardware application.** [Figure 11](#fig-appendix-dense-separable) sets the two shapes beside each other.
